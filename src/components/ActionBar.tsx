...
function NewMark() {
  ...
  return (
      <div className="absolute z-10 bg-white inset-0 max-h-fit w-[300px]">
        ...
        <div className="cursor-pointer">
          <img className="h-[260px] w-full object-cover" src="https://static.vecteezy.com/system/resources/previews/004/141/669/non_2x/no-photo-or-blank-image-icon-loading-images-or-missing-image-mark-image-not-available-or-image-coming-soon-sign-simple-nature-silhouette-in-frame-isolated-illustration-vector.jpg"/>
        </div>
        <div>
          <h2 className="text-center text-2xl font-bold text-primary  my-2 ">фывфывфыв</h2>
          <h3 className="w-[61px] mx-auto text-center rounded-md ${type == 'tree' ? 'text-[#58D364] bg-[#DDFFE0]' : 'text-[#D39658] bg-[#FFEEDD]'}">title</h3>
          <ul className="flex flex-col px-4 my-4 gap-2 max-h-44 overflow-y-scroll ">
          </ul>
          <button  className="block px-4 py-1 m-auto border-solid border-[1px] ${type == 'tree' ? 'text-[#58D364] border-[#58D364]' : 'text-[#D39658] border-[#D39658]'}  rounded mb-2">Сохранить</button>
          <div className="text-center text-gray mb-2">Последнее изменение 02.07.2023 16:37</div>
        </div>
      </div>
  )
}
