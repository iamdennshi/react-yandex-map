...
export default function FurnitureMark(props: FurnitureInfo) {
  ...
  <div class="basis-1/2 flex flex-col">
    ...
    <button onclick="window.editMark(${props.id})" class="block px-4 py-1 m-auto border-solid border-[1px] text-[#D39658] border-[#D39658] rounded mb-2">Редактировать</button>
