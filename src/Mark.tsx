...
export default function Mark(props: MarkInfo) {
  ...
  <ul class="flex flex-col my-4 gap-2 max-h-44 overflow-y-scroll ">
    ...
    <li class="text-[#4A5568]">Комментарий: <span class="font-bold break-words">Дуб хорошо узнаваем благодаря его плодам, желудям</span>
  </ul>
