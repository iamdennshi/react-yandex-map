...
elements = [
     {
        'trees': [
            {'id': 0, 'cords': [58.013436, 56.260534], 'name':'Лиственица', 'photos': ['https://upload.wikimedia.org/wikipedia/commons/thumb/5/56/Sequoiadendron_giganteum_at_Kenilworth_Castle.jpg/450px-Sequoiadendron_giganteum_at_Kenilworth_Castle.jpg'], 'height': 100, 'trunkDiameter': 10, 'ageClass': [10,20], 'typeOfDamage': [0,5], 'crownProjection': 1234, 'aestaticAssessment': 4, 'comment': "Какой-то комментарий", 'recommendation': [0,1], 'trunkNumber': 10, 'sanitaryCondition': 2},
            {'id': 1, 'cords': [58.01296212927088, 56.25939887536343], 'name':'Пихта',  'photos': ['https://gas-kvas.com/grafic/uploads/posts/2023-09/1695808091_gas-kvas-com-p-kartinki-derevo-16.jpg'], 'height': 100, 'trunkDiameter': 10, 'ageClass': [10,20], 'typeOfDamage': [0,5], 'crownProjection': 1234,  'aestaticAssessment': 0, 'comment': "Какой-то комментарий",'recommendation': [0,1], 'trunkNumber': 10, 'sanitaryCondition': 2},
            {'id': 2, 'cords': [58.01320823677178, 56.259917091923946], 'name':'Дуб',  'photos': ['https://get.pxhere.com/photo/landscape-tree-nature-branch-plant-meadow-rural-green-botany-head-deciduous-oak-grove-ecosystem-individually-flowering-plant-biome-sommer-head-woody-plant-land-plant-plane-tree-family-708077.jpg'], 'height': 100, 'trunkDiameter': 10, 'ageClass': [10,20], 'typeOfDamage': [0,5], 'crownProjection': 1234, 'aestaticAssessment': 0, 'comment': "Какой-то комментарий",'recommendation': [0,1], 'trunkNumber': 10,'sanitaryCondition': 2},
        ],
        'furnitures': [
