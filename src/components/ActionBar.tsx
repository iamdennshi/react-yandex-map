          ...
          <div className="bg-[#F2F6F6] rounded-[15px] px-[18px] py-[16px] mt-[12px] active:bg-[#CCDADC] transition-all">
            ...
            <label htmlFor='one' className=''>
              <div className='flex text-primary font-bold'>
                <div className='pr-2 '>
                  <svg className='accordion-arrow rotate-90 h-full transition-all' xmlns="http://www.w3.org/2000/svg" width="7" height="11" viewBox="0 0 7 11" fill="none">
              ...
              <ul className='accordion-item border-t-2 border-[#E6EDEE] mt-2 pt-1'>
